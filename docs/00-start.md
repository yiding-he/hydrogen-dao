...
现在能做到比较好的兼容性的数据库是 Oracle/MySQL/HSQLDB，其他数据库若有不兼容之处，还望不吝指出，我会尽快解决！
...
在适当的地方加入`@Import(com.hyd.dao.spring.SpringAutoConfiguration.class)`即可。具体请参考 `com.hyd.dao.spring.SpringAutoConfiguration` 类。
